...
| `insee_population` | Série historique du recensement — INSEE (population since 1968, dwellings by occupancy, births, deaths, area) | https://api.insee.fr/melodi/file/DS_RP_SERIE_HISTORIQUE_2023/PARQUET | Licence Ouverte 2.0 | yearly | commune | 1968 → 2023 (census years) | Parquet (long) | HTTP download, filtered to scope | high |
